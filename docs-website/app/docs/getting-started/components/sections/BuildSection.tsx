...
└── index.html    # Entry point`}
        ...
        <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-xl">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              <strong>Module Federation Errors:</strong>
              <span className="text-sm ml-2">
                Ensure remote apps are built before the host app
              </span>
            </li>
            <li>
              <strong>Bundle Size Issues:</strong>
              <span className="text-sm ml-2">
                Review and optimize imports, use code splitting
              </span>
            </li>
            <li>
              <strong>Asset Loading Problems:</strong>
              <span className="text-sm ml-2">
