          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <code className="bg-blue-100 px-2 py-1 rounded">port</code>:
   ...
   "shell": {
      ...
      "url": "http://localhost:3000"
          ...
          <div className="mt-4 p-4 bg-blue-50 rounded-lg">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <code className="bg-blue-100 px-2 py-1 rounded">project</code>:
                Name of your project
              </li>
              <li>
                <code className="bg-blue-100 px-2 py-1 rounded">webapp</code>:
                Framework being used (vue3)
              </li>
              <li>
                <code className="bg-blue-100 px-2 py-1 rounded">bundler</code>:
          ...
          <div className="space-y-4">
            <div className="p-4 bg-yellow-50 rounded-lg">
              ...
              <p className="text-sm">
                ...
                <code className="bg-yellow-100 px-2 py-1 rounded">apps/</code>{" "}
                directory.
              </p>
            </div>

            <div className="p-4 bg-blue-50 rounded-lg">
              <h4 className="font-semibold text-blue-800 mb-2">Port Numbers</h4>
              <p className="text-sm">
