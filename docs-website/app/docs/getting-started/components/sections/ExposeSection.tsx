      ...
      "Hello": {
        ...
        "remoteComponentValue": "remote-app/Hello"
          ...
          <div className="mt-4 p-4 bg-blue-50 rounded-lg">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <code className="bg-blue-100 px-2 py-1 rounded">source</code>:
              ...
              <li>
                <code className="bg-blue-100 px-2 py-1 rounded">remotes</code>:
        ...
        <div className="bg-gray-50 p-6 rounded-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-4 bg-purple-50 rounded-lg">
              <h4 className="font-semibold text-purple-700 mb-2">Do&apos;s</h4>
        ...
        <div className="p-6 bg-gradient-to-r from-pink-50 to-rose-50 rounded-xl">
          ...
          <ol className="list-decimal pl-5 space-y-2">
            ...
            <li>
              ...
              <p className="text-sm text-gray-600">
                Import and use the exposed component in your host application to
                verify the setup
              </p>
            </li>
          </ol>
